...
function* getLoginRes(payload) {
  ...
  try {
    ...
    yield put(actions.getActionAsync('GET_LOGIN_RES', 'SUCCESS', { data }))
...
export default function* getLoginResWatcher() {
  // console.info('getSavedUserVisitActionsMdbWatcher START_USER_SESSION', )
  yield takeEvery(['GET_LOGIN_RES_REQUEST'],
    getLoginRes)
}
